...
typedef enum BMP581_OutputDataRate {
    BMP_581_ODR_240_HZ = 0x0,
    BMP_581_ODR_120_HZ = 0x8,
    BMP_581_ODR_60_HZ = 0xE,
    BMP_581_ODR_1_HZ = 0x1C
...
int BMP581_Driver_SetOutputDataRate(BMP581_Driver *driver, BMP581_OutputDataRate odr);
int BMP581_Driver_SetPowerMode(BMP581_Driver *driver, BMP581_PowerMode pwr_mode);